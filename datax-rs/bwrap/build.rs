...
/// 2. The vendored bubblewrap tree under `datax-rs/vendor/bubblewrap`.
...
Set CODEX_BWRAP_SOURCE_DIR to an existing checkout or vendor bubblewrap under datax-rs/vendor.",
        vendor_dir.display()
    ))
}
