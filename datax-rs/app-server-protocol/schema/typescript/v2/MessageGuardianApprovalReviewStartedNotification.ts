 ...
 */
export type MessageGuardianApprovalReviewStartedNotification = { chatId: string, interactionId: string,
/**
 ...
 */
targetMessageId: string | null, review: GuardianApprovalReview, action: GuardianApprovalReviewAction, };
