...
use datax_protocol::approvals::ExecPolicyAmendment as CoreExecPolicyAmendment;
use datax_protocol::approvals::NetworkApprovalContext as CoreNetworkApprovalContext;
use datax_protocol::approvals::NetworkApprovalProtocol as CoreNetworkApprovalProtocol;
use datax_protocol::approvals::NetworkPolicyAmendment as CoreNetworkPolicyAmendment;
use datax_protocol::approvals::NetworkPolicyRuleAction as CoreNetworkPolicyRuleAction;
use datax_protocol::models::ActivePermissionProfile as CoreActivePermissionProfile;
...
impl SandboxPolicy {
    pub fn to_core(&self) -> datax_protocol::protocol::SandboxPolicy {
        match self {
...
impl From<datax_protocol::protocol::SandboxPolicy> for SandboxPolicy {
    fn from(value: datax_protocol::protocol::SandboxPolicy) -> Self {
        match value {
            datax_protocol::protocol::SandboxPolicy::DangerFullAccess => {
                SandboxPolicy::DangerFullAccess
            }
            datax_protocol::protocol::SandboxPolicy::ReadOnly { network_access } => {
                SandboxPolicy::ReadOnly { network_access }
            }
            datax_protocol::protocol::SandboxPolicy::ExternalSandbox { network_access } => {
