 ...
 */
export type MessageGuardianApprovalReviewCompletedNotification = { chatId: string, interactionId: string,
/**
 ...
 */
targetMessageId: string | null, decisionSource: AutoReviewDecisionSource, review: GuardianApprovalReview, action: GuardianApprovalReviewAction, };
