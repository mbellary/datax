...
use datax_app_server_protocol::McpElicitationEnumSchema;
use datax_app_server_protocol::McpElicitationPrimitiveSchema;
use datax_app_server_protocol::McpElicitationSingleSelectEnumSchema;
...
use datax_protocol::mcp_approval_meta::APPROVAL_KIND_KEY as APPROVAL_META_KIND_KEY;
use datax_protocol::mcp_approval_meta::APPROVAL_KIND_MCP_TOOL_CALL as APPROVAL_META_KIND_MCP_TOOL_CALL;
use datax_protocol::mcp_approval_meta::APPROVAL_KIND_TOOL_SUGGESTION as APPROVAL_META_KIND_TOOL_SUGGESTION;
use datax_protocol::mcp_approval_meta::PERSIST_ALWAYS as APPROVAL_PERSIST_ALWAYS_VALUE;
use datax_protocol::mcp_approval_meta::PERSIST_KEY as APPROVAL_PERSIST_KEY;
use datax_protocol::mcp_approval_meta::PERSIST_SESSION as APPROVAL_PERSIST_SESSION_VALUE;
use datax_protocol::mcp_approval_meta::TOOL_NAME_KEY;
use datax_protocol::mcp_approval_meta::TOOL_PARAMS_DISPLAY_KEY as APPROVAL_TOOL_PARAMS_DISPLAY_KEY;
use datax_protocol::mcp_approval_meta::TOOL_PARAMS_KEY as APPROVAL_TOOL_PARAMS_KEY;
...
mod tests {
    ...
    fn submit_sends_accept_with_typed_content() {
        ...
        assert_eq!(resolved_chat_id, chat_id);
        assert_eq!(
            op,
