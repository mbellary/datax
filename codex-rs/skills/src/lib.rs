...
const SYSTEM_SKILLS_MARKER_FILENAME: &str = ".datax-system-skills.marker";
const SYSTEM_SKILLS_MARKER_SALT: &str = "v1";

/// Returns the on-disk cache location for embedded system skills from an absolute DATAX_HOME.
...
/// Installs embedded system skills into `DATAX_HOME/skills/.system`.
///
