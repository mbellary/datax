...
use datax_protocol::protocol::SkillDependencies as CoreSkillDependencies;
use datax_protocol::protocol::SkillInterface as CoreSkillInterface;
use datax_protocol::protocol::SkillMetadata as CoreSkillMetadata;
use datax_protocol::protocol::SkillScope as CoreSkillScope;
use datax_protocol::protocol::SkillToolDependency as CoreSkillToolDependency;
...
pub enum PluginAvailability {
    ...
    /// Upstream Codex app-server exposes `"AVAILABLE"` in its API; the alias
    /// keeps decoding compatible with that upstream response.
