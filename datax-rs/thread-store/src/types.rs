...
pub struct ChatPersistenceMetadata {
...
#[derive(Clone, Debug, PartialEq, Eq, Serialize, Deserialize)]
pub struct LoadChatHistoryParams {
    /// Thread id to load.
    pub chat_id: ChatId,
...
#[derive(Clone, Debug, PartialEq, Eq, Serialize, Deserialize)]
pub struct ReadChatByRolloutPathParams {
...
pub struct ListInteractionsParams {
    ...
    pub messages_view: StoredInteractionMessagesView,
}
...
pub struct StoredInteraction {
    ...
    /// Persisted rollout items associated with this turn, according to `messages_view`.
    pub items: Vec<RolloutMessage>,
    ...
    /// store.
    pub interaction_created_at_ms: Option<i64>,
...
/// Store-owned chat metadata used by list/read/resume responses.
#[derive(Clone, Debug, Serialize, Deserialize)]
...
/// Parameters for patching mutable chat metadata.
#[derive(Clone, Debug, Serialize, Deserialize)]
pub struct UpdateChatMetadataParams {
    /// Thread id to update.
    pub chat_id: ChatId,
    /// Patch to apply.
    pub patch: ChatMetadataPatch,
    /// Whether archived threads are eligible.
    pub include_archived: bool,
}
...
mod tests {
    ...
    #[test]
    fn chat_metadata_patch_accepts_missing_fields() {
        let decoded: ChatMetadataPatch =
    ...
    #[test]
    fn chat_metadata_patch_merge_uses_presence_semantics() {
        let mut current = ChatMetadataPatch {
        ...
        current.merge(ChatMetadataPatch {
            name: Some(None),
            preview: None,
