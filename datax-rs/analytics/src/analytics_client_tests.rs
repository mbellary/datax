...
fn normalize_path_for_skill_id_repo_scoped_uses_relative_path() {
    ...
    let skill_path = PathBuf::from("/repo/root/.datax/skills/doc/SKILL.md");
    ...
    assert_eq!(path, ".datax/skills/doc/SKILL.md");
}
...
fn normalize_path_for_skill_id_admin_scoped_uses_absolute_path() {
    let skill_path = PathBuf::from("/etc/datax/skills/doc/SKILL.md");
...
fn normalize_path_for_skill_id_repo_root_not_in_skill_path_uses_absolute_path() {
    let repo_root = PathBuf::from("/repo/root");
    let skill_path = PathBuf::from("/other/path/.datax/skills/doc/SKILL.md");
    ...
    reducer
        .ingest(
            AnalyticsFact::ClientResponse {
                ...
                response: Box::new(ClientResponsePayload::ChatArchive(ChatArchiveResponse {})),
            },
            &mut events,
        )
        .await;
...
async fn turn_event_counts_completed_tool_items() {
    ...
    let mcp_tool_call_item = |status, duration_ms| Message::McpToolCall {
        id: "mcp-1".to_string(),
