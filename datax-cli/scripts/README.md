...
When `--package datax` is provided, the staging helper builds the lightweight
`datax` meta package plus all platform-native `datax` variants that are later
published under platform-specific dist-tags.
