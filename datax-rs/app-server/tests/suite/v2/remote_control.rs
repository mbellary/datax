...
use datax_app_server::RemoteControlStartupMode;
use datax_app_server::run_main_with_transport_options;
use datax_app_server_protocol::JSONRPCError;
use datax_app_server_protocol::JSONRPCResponse;
use datax_app_server_protocol::RemoteControlClient;
use datax_app_server_protocol::RemoteControlClientsListOrder;
use datax_app_server_protocol::RemoteControlClientsListParams;
use datax_app_server_protocol::RemoteControlClientsListResponse;
use datax_app_server_protocol::RemoteControlClientsRevokeParams;
use datax_app_server_protocol::RemoteControlClientsRevokeResponse;
...
use datax_app_server_protocol::RemoteControlStatusReadResponse;
...
async fn explicit_remote_control_startup_fails_when_disabled_by_requirements() -> Result<()> {
    ...
    let _codex_home_guard = EnvVarGuard::set("DATAX_HOME", codex_home.path().as_os_str());
